...
villages <- st_read("output/res_centroidNSV.gpkg") 
villages <- villages |>
...
write.csv(optimal_sites |> st_set_geometry(NULL), "output/optimal_sitesNSV.csv", row.names = FALSE)
st_write(optimal_sites, "output/optimal_sitesNSV.gpkg", append = FALSE)
