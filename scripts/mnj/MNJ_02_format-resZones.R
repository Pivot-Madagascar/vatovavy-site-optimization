...
#' 
#' Note that loading this data and processing it requires at least 20 GB RAM.
...
catchments <- st_read("output/catchmentMNJ.gpkg")
res_zones <- st_read("data/mnj/zoneresMNJ.gpkg")
buildings <- st_read("data/mnj/batimentMNJ.gpkg")
...
st_write(res_centroid, "output/res_centroidMNJ.gpkg", append = FALSE)
